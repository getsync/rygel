...
form.section("Partie 1", () => {
    form.output(html`
    <p>Pour chaque item, veuillez entourer l'affirmation qui correspond le mieux à votre situation des 7 derniers jours.</p>
`)

    form.enumRadio("endormissement", "1. Endormissement :", [
    ...
    form.enumRadio("sommeilPendantLaNuit", "2. Sommeil pendant la nuit :", [
    ...
    form.enumRadio("reveilAvantHeurePrevu", "3. Réveil avant l'heure prévue :", [
    ...
    form.enumRadio("sommeilexcessif", "4. Sommeil excessif :", [
    ...
    form.enumRadio("tristesse", "5. Tristesse :", [
    ...
    form.enumRadio("diminutionApetit", "6. Diminution de l'apétit :", [
    ...
    form.enumRadio("augmentationApetit", "7. Augmentation de l'apétit :", [
        [0, "J’ai le même appétit que d’habitude"],
    ...
    form.enumRadio("perteDePoids", "8. Perte de poids (au cours des 15 derniers jours) :", [
    ...
    form.enumRadio("priseDePoids", "9. Prise de poids (au cours des 15 derniers jours) :", [
        [0, "Mon poids n’a pas changé."],
...
form.section("Partie 2", () => {
    form.enumRadio("concentrationPriseDeDecision", "10. Concentration/Prise de décisions :", [
    ...
    form.enumRadio("opinionDeMoiMeme", "11. Opinion de moi-même :", [
    ...
    form.enumRadio("ideeDeMortSuicide", "12. Idée de mort ou Suicide :", [
    ...
    form.enumRadio("enthousiasmeGeneral", "13. Enthousiasme Général :", [
    ...
    form.enumRadio("energie", "14. Energie :", [
    ...
    form.enumRadio("impressionDeRalentissement", "15. Impression de ralentissement :", [
    ...
    form.enumRadio("impressionDAgitation", "16. Impression d'agitation :", [
